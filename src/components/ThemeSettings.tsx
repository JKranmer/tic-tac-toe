              ...
              {themes.map((t) => (
                <button
                  ...
                  className={clsx(
                    ...
                    theme === t.id ? 'bg-brand/10 text-brand' : 'text-secondary hover:text-primary hover:bg-page' // hover:bg-gray-100 logic replaced by semantic tokens
                  )}
                >
                  <span>{t.icon}</span>
                  {t.label}
                  {theme === t.id && <span className="ml-auto text-brand">✓</span>}
                </button>
              ))}
            </div>
          </motion.div>
